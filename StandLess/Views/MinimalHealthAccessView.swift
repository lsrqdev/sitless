...
struct MinimalHealthAccessView: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            Text("StandLess reads your standing time from Apple Health to show how much of today you spent standing versus sitting. Your health data always stays on this device.")
                .font(.body)
