...
struct OnboardingView: View {
    ...
    private static let pages: [Page] = [
        Page(
            ...
            subtitle: "Sitless helps you understand how much of your day you spend standing."
        ),
        Page(
            systemImage: "applewatch",
            title: "Your Apple Watch already measures standing activity.",
            subtitle: "Sitless turns that information into simple daily and weekly trends."
        ),
        Page(
